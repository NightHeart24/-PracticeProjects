public class CreateDiamond {
    ...
    private void printTopHalf(String[][] createTopLeft, String[][] createTopRight) {
    ...
    private void printBottomHalf(String[][] bottomLeft, String[][] bottomRight) {
    ...
    private String[][] createBottomRight() {
    ...
    private String[][] createBottomLeft() {
